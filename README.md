...
4. Install ROS for the server. Refer to the [ROS official website](http://wiki.ros.org/Distributions) for installation instructions. (In this version, Linux 18.04 LTS Melodic was used. Therefore, the operation on other platforms or distributions is not guaranteed.)
